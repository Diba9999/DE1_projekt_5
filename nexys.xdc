...
# -----------------------------------------------
# Push buttons  -   Ovládání svitu a rychlosti 
# rychlost(up and down), center = reset, btnl = uprava svitu, btnr = uprava rychlosti 
# -----------------------------------------------
...
# -----------------------------------------------
# LEDs  -  indikace přepínaču sw0 a sw1
# -----------------------------------------------
...
# ---------------------------------------------
# Seven-segment  -  Zobrazování úrovně svitu a rychlosti
# cathodes CA..CG + DP (active-low)
# seg[6]=A ... seg[0]=G--
# -----------------------------------------------
...
# -----------------------------------------------
# Seven-segment  -  Číslo 0 až 99 => potřeba vrpních dvou segmentovek
# anodes AN7..AN0 (active-low)  
# -----------------------------------------------
